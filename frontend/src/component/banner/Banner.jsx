...
const Banner = () => {
  const pf="https://shubham-ns-backend.onrender.com/images/";
  ...
  useEffect(() => {
    const fetchalluser = async () => {
      const res = await axios.get("https://shubham-ns-backend.onrender.com/api/users/");
      setusers(res.data);
      setisuser(true);
    };
    const fetchallnotes = async () => {
      const res = await axios.get("https://shubham-ns-backend.onrender.com/api/notes/");
      setnotes(res.data);
      setisnotes(true);
    };
    fetchallnotes();
